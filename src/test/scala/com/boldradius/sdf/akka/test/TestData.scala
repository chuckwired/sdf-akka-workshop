...
object TestData {
  val requests = List(Request(1, 1, Session.urls(0), Session.referrers(0), "ie"),
                        Request(2, 2, Session.urls(1), Session.referrers(1), "firefox"),
                        Request(3, 3, Session.urls(2), Session.referrers(2), "firefox"),
